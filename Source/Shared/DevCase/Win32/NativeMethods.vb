...
Imports DevCase.Win32.Interfaces
...
#Region " Kernel32.dll "
        ...
        Friend Shared Function FreeConsole() As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
...
#Region " Shell32.dll "
        ...
        ' Unused P/Invokes. They may be helpful in the future.
#If DEBUG Then
